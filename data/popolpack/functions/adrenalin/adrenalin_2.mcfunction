summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1,tag:{CustomPotionColor:16744448,display:{Name:'[{"translate": "item.potion.adrenalin","italic":false}]'},CustomPotionEffects:[{Id:1b,Duration:200,Amplifier:4b},{Id:19b,Duration:200,Amplifier:1b}]}}}
