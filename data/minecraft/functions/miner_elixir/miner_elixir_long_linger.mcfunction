summon item ~ ~ ~ {Item:{id:"minecraft:lingering_potion",Count:1,tag:{CustomPotionColor:16776960,display:{Name:'[{"translate": "item.potion.miner_elixir_linger","italic":false}]'},CustomPotionEffects:[{Id:3b,Duration:1800,Amplifier:0b}]}}}
