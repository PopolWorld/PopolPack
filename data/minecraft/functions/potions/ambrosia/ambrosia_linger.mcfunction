summon item ~ ~ ~ {Item:{id:"minecraft:lingering_potion",Count:1,tag:{CustomPotionColor:65535,display:{Name:'[{"text":"Ambrosia","italic":false}]'},CustomPotionEffects:[{Id:11b,Duration:50,Amplifier:4b}]}}}
