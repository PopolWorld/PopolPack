summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1,tag:{CustomPotionColor:16776960,display:{Name:'[{"text":"Miner\'s Elixir","italic":false}]'},CustomPotionEffects:[{Id:3b,Duration:2400,Amplifier:0b}]}}}
