summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1,tag:{CustomPotionColor:16776960,display:{Name:'[{"text":"Miner\'s Elixir","italic":false}]'},CustomPotionEffects:[{Id:3,Duration:6000,Amplifier:0}]}}}
