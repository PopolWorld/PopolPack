summon item ~ ~ ~ {Item:{id:"minecraft:splash_potion",Count:1,tag:{CustomPotionColor:16776960,display:{Name:'[{"translate": "item.potion.miner_elixir","italic":false}]'},CustomPotionEffects:[{Id:3b,Duration:2400,Amplifier:0b}]}}}
