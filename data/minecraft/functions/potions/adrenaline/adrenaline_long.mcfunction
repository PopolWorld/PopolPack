summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1,tag:{CustomPotionColor:16744448,display:{Name:'[{"text":"Adrenaline","italic":false}]'},CustomPotionEffects:[{Id:1b,Duration:600,Amplifier:2b},{Id:19b,Duration:600,Amplifier:0b}]}}}
