summon item ~ ~ ~ {Item:{id:"minecraft:splash_potion",Count:1,tag:{CustomPotionColor:65535,display:{Name:'[{"translate": "item.potion.ambrosia_splash","italic":false}]'},CustomPotionEffects:[{Id:11b,Duration:200,Amplifier:4b}]}}}
